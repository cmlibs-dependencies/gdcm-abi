/*=========================================================================
  ...
  Module:  $URL: https://gdcm.svn.sourceforge.net/svnroot/gdcm/tags/gdcm-2-0-12/Utilities/VTK/Applications/gdcm2vtk.cxx $
...
void PrintVersion()
{
  ...
  const char date[] = "$Date: 2009-06-12 14:38:35 +0200 (Fri, 12 Jun 2009) $";
